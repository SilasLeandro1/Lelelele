                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                            ...
                                            <ul class="nav navbar-nav navbar-right">
                                                ...
                                                <li><a href="tabela.php">Tabelas</a></li>
                                ...
                                <div class="main_service_content">
                                    <div class="service_tabe">
                                        ...
                                        <ul class="service_tabe_menu nav nav-tabs" role="tablist">
											...
											<li role="presentation"><a href="#gamedesig" aria-controls="gamedesig" role="tab" data-toggle="tab"><i class="fa fa-map-marker"></i> <br />Calculadora</a></li>
                                        </ul>
										</center>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="single_tab_content">
                                                                ...
                                                                <a href="oqdiabetes.html" class="btn btn-primary">Leia Mais</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="single_tab_content">
                                                              ...
                                                              <a href="tipodiabetes.html" class="btn btn-primary">Leia mais</a>
...
em confira nossas receitas.																</p>
                                                                ...
                                                                <a href="receitasdiet.html" class="btn btn-primary">Confira nossas Receitas</a>
                                                            </div>
                                                        </div>
											  ...
											  <div role="tabpanel" class="tab-pane" id="gamedesig">
                                                <div class="single_service_tab">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="single_tab_content">
															    ...
															    ingeridos e a glicose em uma determinada refeição.</p>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Calculadora Glicêmica</h4>
		   <form action="calculadora2.php" method="post">
        </div>
        <div class="modal-body">
           <p class="p2" align="left">  Glicose atual: </p> <center> <input style=" float:left; margin-left:5%;" type="text" id="glicoseatual"  name="glicoseatual" placeholder="Ex: 150"/> </center> </br></br> </br>
         <p class="p2" align="left">  Inicio de correção: </p> <center> <input style=" float:left; margin-left:5%;" type="text" id="valorinicio"  name="valorinicio" placeholder="Ex: 100"/> </center> </br></br> </br>
    <p   style=" float:left;  margin-top:-33%; margin-left:60%;" class="p2" align="left">  Carboidratos Totais: </p> <center> <input style=" margin-top:-28%; float:left; margin-left:60%;"  type="text" id="carboidratototal"  name="carboidratototal" placeholder="Ex: 60g"/> </center> </br></br> </br>
        <p  style=" float:left;  margin-top:-25%; margin-left:60%;" class="p1" align="left">  Valor de divisão: </p> <center> <input  style=" margin-top:-19%; float:left; margin-left:60%;" type="text" id="variavelusuario"  name="variavelusuario" placeholder="Ex: 10"/> </center>
          <p  style=" float:left;  margin-top:-10%; margin-left:7%;" class="p1" align="left"> Incremento de correção: </p> <center> <input  style=" margin-top:-5%; float:left; margin-left:5%;" type="text" id="incremento"  name="incremento" placeholder="Ex: 50"/> </center>
	...
	<script>
				...
				document.getElementById("resultado").innerHTML=insulinaRefeicao;
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="single_tab_content">
                                                                ...
                                                                <br><a href="tabela.php" class="btn btn-primary"> Ver Tabelas </a><br>
                                                            </div>
                                                        </div>
