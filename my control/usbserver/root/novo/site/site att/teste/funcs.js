...
req.onreadystatechange = function() {
	...
	if(req.readyState == 1) {
		document.getElementById('carboidratototal').innerHTML = 'Buscando Alimento...';
	}
	...
	document.getElementById('carboidratototal').innerHTML = resposta;
	}
}
req.send(null);
}
...
req.onreadystatechange = function() {
	...
	if(req.readyState == 1) {
		document.getElementById('carboidratototal').innerHTML = 'Aguarde...';
	}
